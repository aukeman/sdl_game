...
int main( int argc, char** argv ) {
  ...
  struct player_t players[2] = {
    { { 175, 225 }, { 0, 0 }, &default_player, control__get_state(0), FALSE, FALSE, FALSE, FALSE, PLAYER__JUMP_STATE_NONE, { 255, 0,   0 } },
    { { 225, 225 }, { 0, 0 }, &default_player, control__get_state(1), FALSE, FALSE, FALSE, FALSE, PLAYER__JUMP_STATE_NONE, {   0, 0, 255 } }
  };
