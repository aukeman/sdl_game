				    ...
				    struct geo__vector_t* new_velocity )
{
  if ( !new_velocity ) {
    ...
    const int this_frame_x_acceleration = (config->per_second_x_acceleration * frame_length) / TIMING__TICKS_PER_SECOND;
    const int this_frame_x_decceleration = (config->per_second_x_decceleration * frame_length) / TIMING__TICKS_PER_SECOND;
    ...
    gravity_this_frame = 
      (config->per_second_gravity_acceleration * frame_length)/TIMING__TICKS_PER_SECOND;
